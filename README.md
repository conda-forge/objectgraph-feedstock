...
Feedstock license: [BSD-3-Clause](https://github.com/conda-forge/objectgraph-feedstock/blob/master/LICENSE.txt)
...
<table><tr><td>All platforms:</td>
    <td>
      <a href="https://dev.azure.com/conda-forge/feedstock-builds/_build/latest?definitionId=10855&branchName=master">
        <img src="https://dev.azure.com/conda-forge/feedstock-builds/_apis/build/status/objectgraph-feedstock?branchName=master">
      </a>
    </td>
  </tr>
</table>
...
Once the `conda-forge` channel has been enabled, `objectgraph` can be installed with:

```
conda install objectgraph
```

It is possible to list all of the versions of `objectgraph` available on your platform with:
